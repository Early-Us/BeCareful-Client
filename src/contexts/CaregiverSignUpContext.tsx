...
export const CaregiverSignUpProvider = ({
  ...
  const [formData, setFormData] = useState<CaregiverSignUpFormData>({
    ...
    streetAddress: '',
    detailAddress: '',
    caregiverCertificate: { grade: 'NONE', certificateNumber: '' },
    socialWorkerCertificate: { grade: 'NONE', certificateNumber: '' },
    nursingCareCertificate: { grade: 'NONE', certificateNumber: '' },
    isHavingCar: false,
